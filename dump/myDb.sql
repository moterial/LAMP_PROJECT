...
-- 1. create log table .....
CREATE TABLE `myDb`.`Logs` (`eventId` INT UNSIGNED NOT NULL AUTO_INCREMENT , `userID` INT NOT NULL, 
`content` VARCHAR(255) NOT NULL, `created_at` DATETIME NOT NULL, PRIMARY KEY (`eventId`)) ENGINE = InnoDB;
